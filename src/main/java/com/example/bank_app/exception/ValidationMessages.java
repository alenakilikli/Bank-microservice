...
public class ValidationMessages {
    ...
    public static final String MISS_TYPE_NAME = "type name required";
    public static final String NOT_FOUND_TYPE_NAME = "type name is wrong";
    public static final String FROM_ACCOUNT_AND_TO_ACCOUNT_SHOULD_NOT_BE_NULL="account not found";
}
